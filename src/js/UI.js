...
<aside class="aside" id="aside">
    ...
    <aside id="carrito" class="carrito">
      ...
      <div class="carrito-box carrito-box-footer">
        ...
        <button id="btn-checkout" class="carrito-capsula btn-checkout">Confirmar pedido</button>
      </div>
  ...
  <article id="categorias" class="categorias">
    ...
    <div>
      <button id="japon" class="cat-btn">Japon</button>
    </div>
    <div>
      <button id="corea" class="cat-btn">Corea</button>
    </div>
    <div>
      <button id="china" class="cat-btn">China</button>
    </div>
  </article>
